...
public class PDLayoutAttributeObject extends PDStandardAttributeObject
{
    ...
    /**
     * Placement: Before: Placed so that the before edge of the elements
     ...
     * elements allocation rectangle.
     */
    public static final String PLACEMENT_BEFORE                = "Before";
    /**
     * Placement: Start: Placed so that the start edge of the elements
     * allocation rectangle coincides with that of the nearest enclosing
     * reference area. The element may float, if necessary, to achieve the
     * specified placement. Other content that would intrude into the elements
     * allocation rectangle shall be laid out as a runaround.
     */
    public static final String PLACEMENT_START                 = "Start";
    /**
     * Placement: End: Placed so that the end edge of the elements allocation
     ...
     * Other content that would intrude into the elements allocation rectangle
    ...
    /**
     * BlockAlign: Before: Before edge of the first childs allocation rectangle
     * aligned with that of the table cells content rectangle.
     */
     ...
     * between the before edge of the first childs allocation rectangle and
     * that of the table cells content rectangle shall be the same as the
     * distance between the after edge of the last childs allocation rectangle
     * and that of the table cells content rectangle.
     */
    public static final String BLOCK_ALIGN_MIDDLE              = "Middle";
    /**
     * BlockAlign: After: After edge of the last childs allocation rectangle
     * aligned with that of the table cells content rectangle.
     */
    public static final String BLOCK_ALIGN_AFTER               = "After";
    /**
     * BlockAlign: Justify: Children aligned with both the before and after
     * edges of the table cells content rectangle. The first child shall be
    ...
    /**
     * InlineAlign: Start: Start edge of each childs allocation rectangle
     * aligned with that of the table cells content rectangle.
     */
    public static final String INLINE_ALIGN_START              = "Start";
    /**
     * InlineAlign: Center: Each child centered within the table cell. The
     * distance between the start edges of the childs allocation rectangle and
     * the table cells content rectangle shall be the same as the distance
     * between their end edges.
     */
    public static final String INLINE_ALIGN_CENTER             = "Center";
    /**
     * InlineAlign: End: End edge of each childs allocation rectangle aligned
    ...
    /**
     * Gets the width of the elements content rectangle in the
    ...
    /**
     * Sets the width of the elements content rectangle in the
    ...
    /**
     * Gets the height of the elements content rectangle in the
    ...
    /**
     * Sets the height of the elements content rectangle in the
    ...
    /**
     * Gets the offset to account for the separation between the table cells
    ...
    /**
     * Gets the distance by which the elements baseline shall be shifted
    ...
    /**
     * Sets the distance by which the elements baseline shall be shifted
    ...
    /**
     * Gets the elements preferred height in the block-progression direction
    ...
    /**
     * Sets the elements preferred height in the block-progression direction
